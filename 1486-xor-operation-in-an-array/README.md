<h2><a href="https://leetcode.com/problems/xor-operation-in-an-array/?envType=problem-list-v2&envId=math">1610. XOR Operation in an Array</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code> and an integer <code>start</code>.</p>
